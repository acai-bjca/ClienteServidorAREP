...
public class HttpServer2 {
    ...
    /**
     * Este m�todo convierte en un arreglo de bytes el archivo file que se le
     * pas� como par�metro.
     *
     * @param file
     * @param fileLength
    ...
    public static void respuestaSolicitud(Socket clientSocket, PrintWriter out, BufferedReader in,
        ...
        while ((inputLine = in.readLine()) != null) {
            ...
            if (count < 1) {
                solicitud = inputLine; // Lee la primera l�nea de la solicitud
            }
            if (!in.ready()) {
                break;
            }
        ...
        String metodo = tokens.nextToken().toUpperCase(); // Obtenemos el primer token, que en este caso es el m�todo de
        // la solicitud HTTP.
        ...
        // muestre lo que el servidor envi�.
